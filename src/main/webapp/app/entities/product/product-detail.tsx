      ...
      <Row>
        <Col md="8">
          ...
          <dl className="jh-entity-details">
            ...
            <dd>
              <TextFormat value={productEntity.startDt} type="date" format={APP_DATE_FORMAT} />
            </dd>
            <dt>
              <span id="endDt">End Dt</span>
            </dt>
            <dd>
              <TextFormat value={productEntity.endDt} type="date" format={APP_DATE_FORMAT} />
            </dd>
            <dt>Client</dt>
            <dd>{productEntity.clientId ? productEntity.clientId : ''}</dd>
          </dl>
