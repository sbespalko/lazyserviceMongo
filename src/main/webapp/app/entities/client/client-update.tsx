...
export class ClientUpdate extends React.Component<IClientUpdateProps, IClientUpdateState> {
  ...
  render() {
    const { clientEntity, addresses, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="lazyserviceMongoApp.client.home.createOrEditLabel">Create or edit a Client</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : clientEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="client-address" type="select" className="form-control" name="addressId">
                    <option value="" key="0" />
                    {addresses
