package com.sbt.lazyservice.server.config;
...
@Configuration
@EnableMongoRepositories("com.sbt.lazyservice.server.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.sbt.lazyservice.server.config.dbmigrations");
