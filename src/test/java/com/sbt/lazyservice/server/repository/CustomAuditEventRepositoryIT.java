...
import com.sbt.lazyservice.server.config.audit.AuditEventConverter;
import com.sbt.lazyservice.server.domain.PersistentAuditEvent;
...
import static com.sbt.lazyservice.server.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
